<template>
    <div class="bg-white flex h-12 px-4 items-center border-b border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search"
                           class="w-56 bg-gray-200 text-sm pl-8 h-8 rounded-full focus:outline-none focus:shadow-outline"
                           placeholder="Search">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link :to="'/users/' + authUser.data.id" class="px-6 border-b-2 border-white h-full flex items-center">
